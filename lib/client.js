 ...
 *
 * The fourth rule is insurance, not layout: it puts a containing block on this
 * row so the rail's corner dot can never resolve against the initial containing
...
var SIDEBAR_SEAM_CSS = '[data-slot="sidebar"] [class*="logoRow"]{order:-2}'
  ...
  + '[data-slot="sidebar"] [class*="panelGlyph"]:has([data-dsh-remote-badge]){display:contents}'
  + '[data-slot="sidebar"] [class*="panelRow"]:has([data-dsh-remote-badge]){position:relative}';
